        ...
        <React.Fragment>
            <form className={classes.form} onSubmit={handleSubmit(onSubmit)}>
                ...
                <Grid container spacing={2}>
                    <Typography style={{ textAlign: 'center', padding: '4px', marginTop: '16px' }}>
                        We&apos;ve sent you an email recovery code. Please check your email and type the confirmation code, along with
